...
Future<void> saveUserDataToFirestore(String userId, String nickname, String imageUrl) async {
  try {
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Form(
                                key: _formKey,
                                child: TextFormField(
                                  style: const TextStyle(color: Colors.white), //바꾸기
            ...
            Align(
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  child:const Center(child: Text('다음',style: TextStyle(fontSize: 17),)) ),
              ),
            ),
          ],
        ),
